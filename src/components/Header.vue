  ...
  <header class="bg-white dark:bg-gray-50">
    <div class="mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
      <div class="flex h-16 items-center justify-between">
        <div class="flex-1 md:flex md:items-center md:gap-1">
          <svg class="h-4 text-teal-600 dark:text-teal-300" viewBox="0 0 28 24" fill="none"
        ...
        <div class="md:flex md:items-center md:gap-12">
          ...
          <div class="relative hidden md:block">
            <button type="button"
              ...
              <img
                src="https://i.pinimg.com/280x280_RS/6c/60/03/6c60035ab5d15807c09c0a8d2a38121d.jpg"
